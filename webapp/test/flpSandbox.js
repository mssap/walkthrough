		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Walkthrough Application",
									"targetURL": "#boschcowalkthrough-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"boschcowalkthrough-display": {
								"semanticObject": "boschcowalkthrough",
								"action": "display",
								"description": "Walkthrough Application",
								"title": "Walkthrough Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bosch.co.walkthrough",
									"url": sap.ui.require.toUrl("bosch/co/walkthrough")
								}
							}
						}
					}
